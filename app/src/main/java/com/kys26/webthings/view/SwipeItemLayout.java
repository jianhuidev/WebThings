...
public class SwipeItemLayout extends FrameLayout {
	...
	//即第一个参数是ListView，第二个是右边的隐藏的menu，第三个是开启参数(具体不知)，第四个同理
	...
	private void swipe(int dis) {
		...
		//这里是显示的与ListView等高的右边Button参数，其实我也不知道为啥哪里需要-10，不过界面更加美观了;
		menuView.layout(contentView.getWidth() - dis, contentView.getTop(),
