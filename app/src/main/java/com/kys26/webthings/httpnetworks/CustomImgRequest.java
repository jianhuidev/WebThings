...
public class CustomImgRequest {
     ...
     */
    public static String uploadFile(File file, String RequestURL, Map<String, String> params, String uploadFieldName, String Cookie) {
        String result = null;
        try {
