 ...
 */
public class WarningTempActivity extends Activity {
     ...
     */
    private String gwid;
    private String type = "4101";//NH3 4098  湿度 4102
    /**
     * 保存告警
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warning_temp);
...
//        mDegree.setSelection((Integer.valueOf(map.get("openRange").toString())-1),true);
    ...
    private void initView() {
        dialog = IntentDialog.createDialog(WarningTempActivity.this, "正在获取数据......");
