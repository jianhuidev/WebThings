 ...
 */
public class WarningNH3Activity extends Activity {
     ...
     */
    private String gwid;
    private String type = "4098";//NH3 4098  湿度 4102
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warning_nh3);
...
//        mDegree.setSelection((Integer.valueOf(map.get("openRange").toString())-1),true);
    ...
    private void initView() {
        dialog = IntentDialog.createDialog(WarningNH3Activity.this, "正在获取数据......");
        ...
        switch (view.getId()) {
            ...
            case R.id.sure:
                ...
                try {
                    ...
                    MethodTools.comShare = getSharedPreferences("comShare",MODE_PRIVATE);
                    MethodTools.comEdit = MethodTools.comShare.edit();
                    MethodTools.comEdit.putInt("warning1",Integer.valueOf(mHigh.getText().toString()));
                    MethodTools.comEdit.putInt("warning2",Integer.valueOf(mSuphigh.getText().toString()));
                    MethodTools.comEdit.commit();
