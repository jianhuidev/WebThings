package com.kys26.webthings.progress;
 ...
 */
public class NodeProgress extends View implements Runnable {
    /**
     * 读取空进度条图片
     */
     ...
     * 节点名称
     */
    private String[] textArr = new String[]{"开始", "扫描网关", "连接网关","配置网关", "完成"};
    /**
     * 节点数
     */
     ...
     * 白色空心圆半径
     */
    private int r_white = 40;
    /**
     * 蓝色空心圆半径
     */
    private int r_blue = 35;
    /**
     * 白色进度条高度
     */
    private int whiteProgressHeight = 26;
    /**
     * 蓝色进度条高度
     */
    private int blueProgressHeight = 20;
    ...
    public void run() {
        //读取View宽度
        viewWidth = NodeProgress.this.getWidth();
        //读取View高度
        viewHeight = NodeProgress.this.getHeight();
        // 进度条宽度计算
    ...
    public void draw(Canvas canvas) {
        ...
        paint.setTextSize(DensityUtil.dip2px(mContext,textSize));
